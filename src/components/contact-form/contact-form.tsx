...
import LogoSvg from '/public/logo/png/300ppi/icon-dark.png';
...
const ContactFormComponent: FC = () => {
  ...
  return (
    <>
      ...
      <div className="relative bg-[#FFF6ED]">
        {/* SVG Backdrop */}
        ...
        <form
          ...
          className="relative max-w-6xl mx-auto p-4 md:p-6 lg:p-8"
        >
          <div className="lg:flex lg:space-x-12">
            <div className="lg:w-1/2 mb-8 lg:mb-0">
              <h1 className="text-3xl font-bold mb-4">How can we help?</h1>
              <p className="text-gray-500 text-sm mb-4">
                We are constantly working to raise the bar on our services. If
                you have any questions or concerns about your experience, please
                let us know. Our support concierges are available 24/7.
              </p>
            </div>
            ...
            <div className="lg:w-1/2 space-y-4">
              ...
              <div className="flex justify-center sm:justify-start">
                <CustomButton
                  ...
                  type="submit"
                  text="Submit"
                  props="bg-supportColor w-full text-white px-6"
